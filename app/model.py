    ...
    try:
        messages = [
            {"role": "system", 
             ...
             3. 답변을 한 후에는 반드시 현재 질문과 연관된 2-3개의 구체적인 follow-up 질문을 제시하세요.
                - 각 질문은 반드시 새로운 줄에서 '  - ' 형식으로 시작해야 합니다.
                - 일반적인 "추가 문의 사항이 있으신가요?"와 같은 포괄적인 질문은 하지 마세요.
                - 현재 대화 맥락과 관련된 구체적인 질문을 해야 합니다.
        ...
        2. 답변 후에는 반드시 빈 줄을 하나 넣으세요.
        3. 그 다음 줄부터 '  - '로 시작하는 2-3개의 구체적인 follow-up 질문을 제시하세요.
        4. 각 질문은 현재 대화 주제와 직접적으로 연관되어야 합니다.
