    ...
    try:
        messages = [
            {"role": "system", 
             ...
             스마트스토어와 관련이 없는 질문에는 '저는 스마트 스토어 FAQ를 위한 챗봇입니다. 스마트 스토어에 대한 질문을 부탁드립니다.'로만 대답하세요.
             
             스마트스토어와 관련있는 질문에는 다음 지침을 따라 답변해주세요:
        ...
        답변 작성 시 유의사항:
        매우 중요! 스마트스토어와 관련이 없는 질문에는 '저는 스마트 스토어 FAQ를 위한 챗봇입니다. 스마트 스토어에 대한 질문을 부탁드립니다.'로만 대답해주세요
